...
// optional uint32 timeLength = 4;
inline bool TemperatureRequest::has_timelength() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void TemperatureRequest::set_has_timelength() {
  _has_bits_[0] |= 0x00000008u;
}
inline void TemperatureRequest::clear_has_timelength() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void TemperatureRequest::clear_timelength() {
  timelength_ = 0u;
  clear_has_timelength();
}
inline ::google::protobuf::uint32 TemperatureRequest::timelength() const {
  // @@protoc_insertion_point(field_get:TemperatureRequest.timeLength)
  return timelength_;
}
inline void TemperatureRequest::set_timelength(::google::protobuf::uint32 value) {
  set_has_timelength();
  timelength_ = value;
  // @@protoc_insertion_point(field_set:TemperatureRequest.timeLength)
}
